...
interface GameModeInputBo5Props {
  gameId: string;
  mapId: string;
 ...
 * @returns
 */
export function GameModeInputBo5({
  gameId,
  mapId,
  register,
  defaultValue,
  error,
}: GameModeInputBo5Props) {
    ...
    <div className="border-l-4 border-slate-500 rounded mb-4">
      <div className="flex items-center pt-2">
        <select
          ...
          value={gameMode}
          {...register(gameId as keyof validationSchemaTypeBo5, {
        ...
        <select
          ...
          {...register(mapId as keyof validationSchemaTypeBo5)}
        >
